...
LoadDualPCM:
		...
		move.w	#$0100,$A11200.l	; Z80 reset off
...
.ntsc
		move.b	d0,dZ80+YM_FlushTimer+2.l; save flush timer

		move.w	#$0000,$A11200.l	; request Z80 reset
		moveq	#$7F,d1			; wait for a little bit
		dbf	d1,*			; we can't check for reset, so we need to delay

		move.w	#$0000,$A11100.l	; enable Z80
		move.w	#$0100,$A11200.l	; Z80 reset off
